          ...
          <div class="card-body">
              ...
              @method('PUT')
                  <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" id="horizontal-firstname-input" value="{{ $category->title }}">
                      </div>
                  </div>
                  <div class="form-group row mb-4">
                      <label for="horizontal-email-input" class="col-sm-2 col-form-label">Description</label>
                      <div class="col-sm-10">
                          <input type="text" name="description" class="form-control" id="horizontal-email-input" value="{{ $category->description }}">
                      </div>
                  </div>  
                  <div class="form-group row mb-4">
