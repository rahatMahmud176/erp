                ...
                <div class="col-xl-12">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="text-muted font-weight-medium">Cash</p>
                        ...
                        @foreach ($agents as $agent)
                         ...
                         <div class="col-md-4">
                            <a href="{{ route('agent-payment-details',['id'=>$agent->id]) }}"  > 
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <p class="text-muted font-weight-medium">{{ $agent->title }}</p>
                                                <h4 class="mb-0"> ৳:{{ $agent->due }} </h4>
                                            </div>
