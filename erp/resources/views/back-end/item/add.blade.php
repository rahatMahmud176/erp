                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="s_description" class="form-control" id="" cols="30" rows="3"></textarea>
                                    </div>
                                </div> 
                            </div>  
                    </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9"> 
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="purchase_price" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Sell</span>
                                      </div>
                                      <input type="text" name="sell_price" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                  </div>
                                  <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="inputGroup-sizing-default">Re-Seller Price</span>
                                    </div>
                                    <input type="text" name="re_sell_price" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                                   </div>
                ...
                <div class="card">
                    <div class="card-body">  
                        <label for="">Long Description</label>
                            <textarea name="l_description" class="container-fluid form-control summernote" id=""></textarea>
