        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashbord') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('/') }}assets/images/InventoryLogo.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/') }}assets/images/InventoryLogo.svg" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="{{ route('dashbord') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('/') }}assets/images/InventoryLogo.svg" alt="" height="19">
                    </span>
                </a>
            </div>
